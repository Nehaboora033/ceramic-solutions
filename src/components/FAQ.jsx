            ...
            <div className='max-w-[1140px] mx-auto px-3 mb-[140px]'>
                ...
                <div className='flex flex-col items-center'>
                    {FAQ_DATA.map((item, index) => (
                        <div key={index} className='max-w-[912px] rounded-2xl py-[21px] px-5 mb-6 shadow-slider transition-all duration-150'>
                            <button onClick={() => SetIsOpen(isOpen===index?null:index)} className={`flex justify-between w-full cursor-pointer font-normal text-lg font-jakarta items-center`}>
                                {item.question}
