                            ...
                            <div className='flex flex-col gap-6'>
                                {WHY_CHOOSE_US_DATA.map((item, index) => (
                                    <div key={index} className='flex gap-5'>
                                        <div className='max-w-[62px] max-h-[62px] w-full rounded-[10px] bg-[#F7D3D4] p-[15px] mb-6'>
                                            <item.svg />
                                        </div>
                                        <div>
                                            <p className='font-semibold text-xl font-jakarta'>{item.heading} </p>
                                            <p className='font-noraml text-base font-jakarta mt-3 max-w-[370px] w-full'>{item.description} </p>
                                        </div>
                                    </div>
                                ))}
                            </div>
